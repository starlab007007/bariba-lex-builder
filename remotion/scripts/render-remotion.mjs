...
if (!compId || !out) { console.error('Usage: node render-remotion.mjs <compId> <outPath>'); process.exit(1); }
...
console.log(`[render] rendering ${compId} (${composition.durationInFrames} frames @ ${composition.fps}fps)…`);
