...
export const LANGUAGE_CONFIG: Record<LearningLanguage, LanguageConfig> = {
  french: {
    ...
    ui: {
      ...
      foundations: 'Connaissances fondamentales',
      foundationsSub: 'Grammaire, conjugaison, nombres, tons...',
      startLesson: 'Étudier',
      sections: 'sections',
      quiz: 'Quiz',
  ...
  bariba: {
    ...
    ui: {
      ...
      foundations: 'Debu tɛntɛmɑnu',
      foundationsSub: 'Grammaire, koru kpindu, nɛɛrɑnu, nɔɔseeru...',
      startLesson: 'Debu',
      sections: 'yɔɔrenu',
      quiz: 'Quiz',
      quizScore: 'Quiz karɛ',
