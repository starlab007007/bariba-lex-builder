...
export const TEXT_PRODUCTION_TYPES: TextType[] = [
  // ===== 1. LETTRE FAMILIÈRE =====
  {
    ...
    structure: [
      { label: 'Dɔgɔru ka saaru', labelFr: 'Lieu et date', placeholder: 'Naanaanu, 15/03/2026', type: 'short', color: 'bg-pink-50 border-pink-200' },
      { label: 'Wìn yore tireru', labelFr: 'Expéditeur', placeholder: 'Kpaaru Sabi', type: 'short', color: 'bg-rose-50 border-rose-200' },
      { label: 'Wìn sɔ̃ ba tireru gɔ̃ɔnɛ', labelFr: 'Destinataire', placeholder: 'N dɔɔkiru Saaru', type: 'short', color: 'bg-purple-50 border-purple-200' },
      { label: 'Garin kɔ̃ɔ daakari', labelFr: 'Formule d\'appel', placeholder: 'N dɔɔkiru Saaru kãɛsinɛ,', type: 'short', color: 'bg-violet-50 border-violet-200' },
      { label: 'Tireru yobu', labelFr: 'Corps', placeholder: 'N wunɛ tireru yeni yorumɔ n ka wunɛ sɔ̃ mɛ̃ n wãa alaafiya sɔɔ...', type: 'long', color: 'bg-blue-50 border-blue-200' },
      { label: 'Garin kɔ̃ɔ bìnu', labelFr: 'Formule finale', placeholder: 'N wunɛ fɔɔnɛ too.', type: 'short', color: 'bg-indigo-50 border-indigo-200' },
      { label: 'Gɔ̀kɔ̀ru', labelFr: 'Signature', placeholder: 'Kpaaru Sabi', type: 'short', color: 'bg-gray-50 border-gray-200' },
    ],
  ...
  // ===== 2. LETTRE ADMINISTRATIVE =====
  {
    ...
    structure: [
      { label: 'Dɔgɔru ka saaru', labelFr: 'Lieu et date', placeholder: 'Naanaanu, 20/03/2026', type: 'short', color: 'bg-blue-50 border-blue-200' },
      { label: 'Yore tireru', labelFr: 'Expéditeur', placeholder: 'Kpaaru Sabi, Wuun keu koo sɔɔru', type: 'short', color: 'bg-indigo-50 border-indigo-200' },
      { label: 'Gɔ̃ɔnɛ', labelFr: 'Destinataire', placeholder: 'Wuu Sunɔ Bɛɛru, Naanaanu', type: 'short', color: 'bg-violet-50 border-violet-200' },
      { label: 'Gariyoo', labelFr: 'Objet', placeholder: 'Dii yãa dwebu bikiabu', type: 'short', color: 'bg-purple-50 border-purple-200' },
      { label: 'Tireru yobu', labelFr: 'Corps', placeholder: 'Wuu Sunɔ, n wunɛn bɛ̃ɛrɛ sɔɔ tireru yeni yorumɔwa...', type: 'long', color: 'bg-sky-50 border-sky-200' },
      { label: 'Kɔ̃ɔ kasandibu', labelFr: 'Formule', placeholder: 'N wunɛ fɔɔ bɛ̃ɛrɛ too, Wuu Sunɔ.', type: 'short', color: 'bg-cyan-50 border-cyan-200' },
      { label: 'Gɔ̀kɔ̀ru', labelFr: 'Signature', placeholder: 'Kpaaru Sabi', type: 'short', color: 'bg-gray-50 border-gray-200' },
    ],
  ...
  // ===== 3. TEXTE NARRATIF =====
  {
    ...
    structure: [
      { label: 'SI — Sàasàa seeyabu', labelFr: 'Situation initiale', placeholder: 'Wuu goo sɔɔ bii goo u wãawa...', type: 'long', color: 'bg-emerald-50 border-emerald-200' },
      { label: 'EM — Gariyoo kpaabu', labelFr: 'Élément déclencheur', placeholder: 'Bururu garu, gari goo ta kobu...', type: 'long', color: 'bg-amber-50 border-amber-200' },
      { label: 'EP — Gari baatera', labelFr: 'Péripéties', placeholder: 'U dɔɔ ma u ka...', type: 'long', color: 'bg-blue-50 border-blue-200' },
      { label: 'SA — Sàasàa gɔsiabu', labelFr: 'Solution', placeholder: 'Yera u ka swaa yɛnɔ...', type: 'long', color: 'bg-teal-50 border-teal-200' },
      { label: 'SF — Sàasàa biruse', labelFr: 'Situation finale', placeholder: 'Saa yèn di u ka...', type: 'long', color: 'bg-green-50 border-green-200' },
    ],
  ...
  // ===== 4. ARTICLE DE JOURNAL =====
  {
    ...
    structure: [
      { label: 'Garigoo wiiru', labelFr: 'Titre', placeholder: 'KEU GBIRUSE NAANAANUƆ', type: 'short', color: 'bg-amber-50 border-amber-200' },
      { label: 'Garigoo biru wiiru', labelFr: 'Sous-titre', placeholder: 'Bii mɛro wunɔbu ba keu goo yeni doki', type: 'short', color: 'bg-yellow-50 border-yellow-200' },
      { label: 'Garigoo yobu biruse', labelFr: 'Chapeau', placeholder: 'Naanaanun bii mɛrobu ba keu gbiruse yeni yãa...', type: 'long', color: 'bg-orange-50 border-orange-200' },
      { label: 'Tireru yobu', labelFr: 'Corps', placeholder: 'Naanaanu wuu sɔɔ keu gbirusen bweseru...', type: 'long', color: 'bg-red-50 border-red-200' },
      { label: 'Yore tireru wiiru', labelFr: 'Auteur', placeholder: 'Sabi Kpaaru, tenkurukora', type: 'short', color: 'bg-gray-50 border-gray-200' },
    ],
  ...
  // ===== 5. AFFICHE =====
  {
    ...
    structure: [
      { label: 'Garigoo wiiru bakaru', labelFr: 'TITRE', placeholder: 'BII MƐRO KPURON ALAAFIYA', type: 'short', color: 'bg-red-50 border-red-200' },
      { label: 'Gariyoo', labelFr: 'Sujet', placeholder: 'Bɛsɛ kpuro su n doo vaksinasĩɔnun sɔ̃!', type: 'long', color: 'bg-orange-50 border-orange-200' },
      { label: 'Dɔgɔru ka saaru', labelFr: 'Lieu et date', placeholder: 'Naanaanu maasu dirɔ, 25/03/2026', type: 'short', color: 'bg-yellow-50 border-yellow-200' },
      { label: 'Saabu', labelFr: 'Horaire', placeholder: 'Saa kɔbaa nɔba ita saa kɔbaa wɔkura yiru', type: 'short', color: 'bg-amber-50 border-amber-200' },
      { label: 'Kɔ̃ɔ dabariru', labelFr: 'Message motivant', placeholder: 'VAKSINASĨƆNU YA RA BII MƐRO KƆ̃SIMƆ!', type: 'short', color: 'bg-green-50 border-green-200' },
    ],
  ...
  // ===== 6. TEXTE DESCRIPTIF / PORTRAIT =====
  {
    ...
    structure: [
      { label: 'Wiiru ka kɔ̀kɔrɔ', labelFr: 'Nom et identité', placeholder: 'Saaru ya sãa tɔn kurɔ goowa...', type: 'short', color: 'bg-violet-50 border-violet-200' },
      { label: 'Siibu wãɛru', labelFr: 'Description physique', placeholder: 'U bɛ̃rɛwa, u sãa kõo buaawa...', type: 'long', color: 'bg-purple-50 border-purple-200' },
      { label: 'Siibu yam kɔ̃ɔru', labelFr: 'Caractère', placeholder: 'U sãa tɔn sãawa, u ra tɔnbu dam mɛɛrimɔ...', type: 'long', color: 'bg-fuchsia-50 border-fuchsia-200' },
      { label: 'Win sɔmbu ka yam wãaru', labelFr: 'Habitudes', placeholder: 'U ra sɔmɔ too, u ra bii mɛrobu sɔ̃simɔ...', type: 'long', color: 'bg-pink-50 border-pink-200' },
      { label: 'Gari biruse', labelFr: 'Conclusion', placeholder: 'Tɔn be u sãa tɔn sãa dee deewa...', type: 'long', color: 'bg-rose-50 border-rose-200' },
    ],
