...
export default function TrainingManager() {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'validation' | 'quality'>('overview');
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Gestion de l'Entraînement</h2>
          <p className="text-muted-foreground">
            {totalCount} phrases disponibles, {validatedCount} validées
          </p>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Phrases Totales</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {totalCount > 0 ? ((validatedCount / totalCount) * 100).toFixed(0) : 0}% du total
                </p>
              </CardContent>
            </Card>
      ...
      {activeView === 'validation' && <BulkPhraseValidator />}
