...
export default function TrainingDataViewer() {
  ...
  const filteredPhrases = phrases.filter(p =>
    p.french_text.toLowerCase().includes(searchQuery.toLowerCase()) ||
    p.bariba_text.toLowerCase().includes(searchQuery.toLowerCase())
  );
  ...
  const handleExport = () => {
    ...
    toast({
      title: "Export réussi",
      description: `${phrases.length} phrases exportées`
    });
  };
