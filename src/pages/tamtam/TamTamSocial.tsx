...
// ═══════════════════════════════════════════════════════════════════════════════
// FEED HEADER - ULTRA TRANSPARENT AVEC 3 POINTS CENTRÉ + SWIPE ARROWS
// ═══════════════════════════════════════════════════════════════════════════════
...
const FeedIndicator: React.FC<{ 
  ...
  onSwipeLeft?: () => void;
  onSwipeRight?: () => void;
}> = ({ currentFeed, onMenuOpen }) => {

  return (
    <>
      {/* Menu 3 points centré en haut - ultra transparent */}
      ...
      {/* Swipe Arrows en bas - ultra transparent */}
      <div className="fixed bottom-24 left-0 right-0 z-30 pointer-events-none">
        <div className="flex items-center justify-between px-6">
          ...
          >
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-white/20 -ml-3">
              <polyline points="15 18 9 12 15 6" />
            </svg>
          </motion.div>
          ...
          <motion.div 
            ...
            transition={{ repeat: Infinity, duration: 1.5, ease: 'easeInOut' }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-white/20 -mr-3">
